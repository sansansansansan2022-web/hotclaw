...
async def _run_draft_rerun_task_in_background(task_id: str) -> None:
    """Run a draft-rerun task after the request session has committed."""
...
async def rerun_draft(
    ...
    try:
        ...
        await db.commit()
        bg_task = asyncio.create_task(_run_draft_rerun_task_in_background(new_task.id))
