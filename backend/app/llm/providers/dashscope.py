"""DashScope Provider 实现（阿里云 Qwen 模型）"""
...
class DashScopeProvider(LLMProvider):
    """
    阿里云 DashScope / Qwen 模型 Provider
    ...
    环境变量:
    - DASHSCOPE_API_KEY 或 LITELLM_API_KEY
    """
