...
"""
    ...
    async def execute(self, input_data: dict, context: dict) -> AgentResult:
        ...
        try:
            ...
            return self._attach_runtime_trace(
                self._failure(code="HOT_TOPIC_ERROR", message=str(exc)),
                context,
            )
    ...
    async def fallback(self, error: Exception, input_data: dict) -> AgentResult | None:
        ...
        explicit_reference_digest = input_data.get("reference_digest") if isinstance(input_data.get("reference_digest"), dict) else {}
